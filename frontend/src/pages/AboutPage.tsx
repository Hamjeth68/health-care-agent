      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight mb-4">
            ...
            <span className="text-foreground">AI-Powered Healthcare Monitoring Agent</span>
          </h1>
          <p className="text-muted-foreground text-base max-w-2xl mx-auto leading-relaxed">
            An AI-powered healthcare monitoring agent built with hybrid retrieval-augmented generation,
        ...
        >
          <p className="text-muted-foreground text-xs">
            This AI agent is for informational purposes only. Always consult a qualified healthcare professional for medical advice.
          </p>
        </motion.div>
      </div>
    </motion.main>
